    ...
    export default {
        ...
        methods:{
          ...
          async loadUserComment(){
            let json = await getUserComment(localStorage.getItem('user_id'),this.$route.query.movie_id);
          ...
          async commentBtnHandle(){
            if (this.textarea){
              ...
              let json = await updateUserComment(localStorage.getItem('user_id'),this.$route.query.movie_id,this.score,this.textarea,commentDate);
              if (json.success_code===200){
