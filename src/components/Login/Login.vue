    ...
    <div id="login">
      ...
      <div class="login-container">
        <div class="login-header logo">
          ...
          <p class="title">淘淘电影</p>
          <i class="eng-title">Tao Tao Movie</i>
        </div>
    ...
    export default {
        ...
        data(){
          return{
            ...
            captchaSrc:'http://47.93.8.38:3002/api/captcha',
          }
        },
        methods:{
          //选择登录类型
          ...
          //刷新图形验证码
          refreshCaptcha(){
            this.captchaSrc = 'http://47.93.8.38:3002/api/captcha?time='+new Date();
          },
          //登录
            ...
            if (this.loginType){
              ...
              if (this.phone===''){
                ...
                if (json.success_code===200){
                  ...
                  // this.$cookies.set('user_id',json.$cookies.get('user_id'));
                  // this.localStorage('userId', this.cookie.get('usrId'));
                  this.$router.go(-1);
                } else{
